...
private var myContext = ShareDataObserverContext.First
...
class FirstViewController: UIViewController {
    ...
    @IBAction func changeLable1ButtonClicked(sender: AnyObject) {
        share.setValue("First key1", forKey: ShareDataObserved.key1.rawValue)
    }

    @IBAction func changeLabel2ButtonClicked(sender: AnyObject) {
        share.setValue("First key2", forKey: ShareDataObserved.key2.rawValue)
    }
